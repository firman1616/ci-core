...
-- ----------------------------
-- Records of tbl_master_role_permission
-- ----------------------------
...
CREATE TABLE `tbl_menu`  (
  ...
  `url_menu` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
...
-- Records of tbl_menu
-- ----------------------------
INSERT INTO `tbl_menu` VALUES (1, 'mtc', 'mtc/mtc', 2, NULL, 1);
